...
; ===== 系统 - 快捷键定义区 =====
/*
    在需要按下End键后暂停功能的热键括号里写下面的代码即可暂停对应热键的功能
    global UrlPaused          ; UrlPaused 是对应全局变量和PauseScript函数里的变量
    if (UrlPaused) {          ; ← 关键：检查暂停状态
        QuickTip("音频功能已暂停", 1000)
        return                  ; ← 如果暂停，直接返回，不执行后面的代码
    }
*/
Home:: {    ; 帮助提示
    HelpScript()
